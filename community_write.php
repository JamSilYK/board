                          ...
                          <table cellspacing="0" cellpadding="0" border="0" id="" class="table table-write" style="margin-top:50px">
                            ...
                            <tbody>
                              <tr id="mb_contact_tr_email">
                                ...
                                <td>
                                  <input style="width:200px;" name="com_pass" id="com_pass" value="" type="password" maxlength="50">
                                </td>
                              </tr>
                              <tr id="mb_contact_tr_title">
                                ...
                                <td>
                                  <input class="text-left" style="width:99%;"id="com_title" name="com_title" type="text">
                                </td>
                              </tr>
                              <tr id="mb_contact_tr_content">
                                <td class="content-box" colspan="2">
                                  <input type="hidden" name="data_type" id="data_type" value="html">
                                  <textarea class="content" style="width: 100%; height: 360px;" id="com_contents" name="com_contents" title="내용"></textarea>
                                </td>
                              </tr>
                        ...
                        <div class="write-btn">
                          <div class="btn-box-right" id="contact_btn_box">
                            <div class="btn-box-left" style="text-align:center;">
                              ...
                              <button class="btn btn-default" id="bt_send">등록</button>
                            </div>
                          </div>
                        </div>
                      </div>
